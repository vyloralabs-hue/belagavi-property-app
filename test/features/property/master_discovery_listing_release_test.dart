...
void main() {
  ...
  group(
    'Belagavi Property Master Discovery + Listing + Map Architecture Release Suite',
    () {
      // â”€â”€â”€ TEST 1: RESIDENTIAL LISTING FIELDS & VALIDATION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      test(
        '1. Residential property form validates full specifications and photo count',
        () {
          formNotifier.initForNewProperty('usr_res_101');
          ...
          final entity = formNotifier.state.toEntity('usr_res_101');
      ...
      // â”€â”€â”€ TEST 2: PLOTS & LAYOUTS SPECIFICATIONS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      test(
        '2. Plots & Layouts listing validates dimensions, road width, and NA conversion',
        () {
          formNotifier.initForNewProperty('usr_plot_201');
          formNotifier.updatePropertyType(
          ...
          final entity = formNotifier.state.toEntity('usr_plot_201');
      ...
      // â”€â”€â”€ TEST 3: COMMERCIAL PROPERTY LISTING â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      test(
        '3. Commercial property listing validates frontage, power load, and lease duration',
        () {
          formNotifier.initForNewProperty('usr_comm_301');
          formNotifier.updatePropertyType(
          ...
          final entity = formNotifier.state.toEntity('usr_comm_301');
      ...
      // â”€â”€â”€ TEST 4: RAW LAND LISTING â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      test(
        '4. Raw Land listing validates soil type, RTC reference, water source and acre area',
        () {
          formNotifier.initForNewProperty('usr_land_401');
          formNotifier.updatePropertyType(
          ...
          final entity = formNotifier.state.toEntity('usr_land_401');
      ...
      // â”€â”€â”€ TEST 5: PHOTO REQUIREMENTS (1 DRAFT, 3 PUBLISH) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      test(
        '5. Photo requirements validate 1 photo for draft and 3 photos for publish',
        () {
          formNotifier.initForNewProperty('usr_photo_test');
          formNotifier.updateBasicDetails(
            title: 'Test Property',
            description: 'Desc',
            listingType: 'FOR_SALE',
          ...
          formNotifier.updatePriceAndArea(price: 5000000, carpetArea: 1000);

          // 0 photos -> missing publish field
          expect(
          ...
          formNotifier.addMedia(
            const PropertyMediaEntity(
              id: 'p1',
              propertyId: 'temp',
              mediaUrl: 'https://example.com/p1.jpg',
              type: MediaType.image,
              isCover: true,
            ),
          );
          expect(formNotifier.state.mediaList.isNotEmpty, isTrue);

          // 3 photos -> satisfies publish criteria
          formNotifier.addMedia(
            const PropertyMediaEntity(
              id: 'p2',
              propertyId: 'temp',
              mediaUrl: 'https://example.com/p2.jpg',
              type: MediaType.image,
              isCover: false,
            ),
          );
          formNotifier.addMedia(
            const PropertyMediaEntity(
              id: 'p3',
              propertyId: 'temp',
              mediaUrl: 'https://example.com/p3.jpg',
              type: MediaType.image,
              isCover: false,
            ),
          );
      ...
      // â”€â”€â”€ TEST 6: OPEN-SOURCE MAP RESOLVER & INDIA CONFIG â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      test(
        '6. Open-Source Map Configuration resolves Indian cities and localities without Google billing',
        () {
      ...
      // â”€â”€â”€ TEST 7: LOCALITY-FIRST SEARCH QUERY ENTITY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      test(
        '7. Locality-First SearchQueryEntity constructs bounded queries with strict taxonomy',
        () {
      ...
      // â”€â”€â”€ TEST 8: DISPUTED PROPERTY ISOLATION & PRIVATE DOCS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      test(
        '8. Disputed property entities keep legal records protected and public warning active',
        () async {
      ...
      // â”€â”€â”€ TEST 9: PURCHASE / SALE LEGAL NOTICE RECORD â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      test(
        '9. Legal notice registry protects buyer/seller transactions with public notices',
        () async {
      ...
      // â”€â”€â”€ TEST 10: ZERO-AI DIRECTIVE VALIDATION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      test(
        '10. App positioning maintains pure manual marketplace architecture',
        () {
